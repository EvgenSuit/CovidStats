  ...
  Widget plotData(List<DataMapper> data, String title, bool plotNewCases) {
    return SfCartesianChart(
      ...
      primaryXAxis: CategoryAxis(
          ...
          title: AxisTitle(
              text: 'Dates', textStyle: const TextStyle(color: Colors.white)),
          majorTickLines:
              const MajorTickLines(size: 8, color: Colors.red, width: 4),
          minorTickLines:
              const MinorTickLines(size: 4, color: Colors.blue, width: 2),
